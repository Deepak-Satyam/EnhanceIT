...
import com.enhance.it.app.di.component.DaggerViewHolderComponent
import com.enhance.it.app.di.component.ViewHolderComponent
import com.enhance.it.app.di.module.ViewHolderModule
import com.enhance.it.app.utils.display.Toaster
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as RepositoryApplication).applicationComponent)
